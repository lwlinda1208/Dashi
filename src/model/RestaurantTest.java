...
public class RestaurantTest {
	...
	public void testStringToJsonArray() throws JSONException{
		JSONArray jsonArray=new JSONArray();
		jsonArray.put("Chinese").put("Japanese");
		JSONAssert.assertEquals(jsonArray, Restaurant.stringToJSONArray("Chinese, Japanese"), false);
	}
	
	@Test
	public void testStringToJsonArrayCornerCases() throws JSONException{
		JSONArray jsonArray=new JSONArray();
		JSONAssert.assertEquals(jsonArray, Restaurant.stringToJSONArray(""), false);
		jsonArray.put("Chinese");
		JSONAssert.assertEquals(jsonArray, Restaurant.stringToJSONArray("Chinese"), false);
		JSONAssert.assertEquals(jsonArray, Restaurant.stringToJSONArray("Chinese,"), false);
	}
